...
/mob/proc/make_changeling()
	...
	if(istype(H))
		var/datum/absorbed_dna/newDNA = new(H.real_name, H.dna, H.species.get_bodytype(), H.languages)	//SKYRAT EDIT - Fixes Custom Species interactions with lings
		absorbDNA(newDNA)
...
/mob/proc/changeling_absorb_dna()
	...
	var/datum/absorbed_dna/newDNA = new(T.real_name, T.dna, T.species.get_bodytype(), T.languages) //SKYRAT EDIT - Fixes Custom Species interactions with lings
	absorbDNA(newDNA)
