/datum/species/adherent
	...
	icon_template =           'modular_skyrat/icons/mob/human_races/species/adherent/template.dmi'
	icobase =                 'modular_skyrat/icons/mob/human_races/species/adherent/body.dmi'
	deform =                  'modular_skyrat/icons/mob/human_races/species/adherent/body.dmi'
	preview_icon =            'modular_skyrat/icons/mob/human_races/species/adherent/preview.dmi'
	damage_overlays =         'modular_skyrat/icons/mob/human_races/species/adherent/damage_overlay.dmi'
	damage_mask =             'modular_skyrat/icons/mob/human_races/species/adherent/damage_mask.dmi'
	blood_mask =              'modular_skyrat/icons/mob/human_races/species/adherent/blood_mask.dmi'
...
/datum/species/adherent/New()
	equip_adjust = list(
		"[BP_L_HAND]" = list("[NORTH]" = list("x" = 0, "y" = 14), "[EAST]" = list("x" = 0, "y" = 14), "[SOUTH]" = list("x" = 0, "y" = 14), "[WEST]" = list("x" = 0,  "y" = 14)),
		"[BP_R_HAND]" = list("[NORTH]" = list("x" = 0, "y" = 14), "[EAST]" = list("x" = 0, "y" = 14), "[SOUTH]" = list("x" = 0, "y" = 14), "[WEST]" = list("x" = 0,  "y" = 14)),
