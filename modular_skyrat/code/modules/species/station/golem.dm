/datum/species/golem
	...
	icobase = 'modular_skyrat/icons/mob/human_races/species/golem/body.dmi'
	deform = 'modular_skyrat/icons/mob/human_races/species/golem/body.dmi'
	husk_icon = 'modular_skyrat/icons/mob/human_races/species/golem/husk.dmi'
