/datum/species/tajaran
	name = SPECIES_TAJ
	name_plural = "Tajara"
	icobase = 'modular_skyrat/icons/mob/human_races/species/tajaran/body.dmi'
	deform = 'modular_skyrat/icons/mob/human_races/species/tajaran/deformed_body.dmi'
	husk_icon = 'modular_skyrat/icons/mob/human_races/species/tajaran/husk.dmi'
	preview_icon = 'modular_skyrat/icons/mob/human_races/species/tajaran/preview.dmi'
	modular_tail = 'modular_skyrat/icons/mob/human_races/species/tajaran/tail.dmi'
	tail = "tajtail"
