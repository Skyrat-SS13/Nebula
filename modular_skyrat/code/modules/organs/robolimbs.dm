...
/datum/robolimb/zenghu_taj
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/zenghu/zenghu_taj.dmi'
...
/datum/robolimb/eggnerdltdred
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/rahboopred/rahboopred.dmi'
	//blood_color = "#5e280d"
	includes_tail = 1
	unavailable_at_chargen = 1
/*
...
/datum/robolimb/dsi_tajaran
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/DSITajaran/dsi_tajaran.dmi'
	//blood_color = "#ffe2ff"
	//lifelike = 1
	unavailable_at_chargen = 1
	includes_tail = 1
...
/datum/robolimb/dsi_lizard
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/DSILizard/dsi_lizard.dmi'
	//blood_color = "#ffe2ff"
	//lifelike = 1
	unavailable_at_chargen = 1
	includes_tail = 1
...
/datum/robolimb/dsi_vulpkanin
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/DSIVulpkanin/dsi_vulpkanin.dmi'
	//blood_color = "#ffe2ff"
	//lifelike = 1
	unavailable_at_chargen = 1
	includes_tail = 1
...
/datum/robolimb/dsi_akula
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/DSIAkula/dsi_akula.dmi'
	//blood_color = "#ffe2ff"
	//lifelike = 1
	unavailable_at_chargen = 1
	includes_tail = 1
...
/datum/robolimb/dsi_spider
	...
	icon = 'modular_skyrat/icons/mob/human_races/cyberlimbs/DSISpider/dsi_spider.dmi'
	//blood_color = "#ffe2ff"
	//lifelike = 1
	unavailable_at_chargen = 1
	includes_tail = 1
