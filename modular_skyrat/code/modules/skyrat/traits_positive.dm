...
/datum/trait/melee_attack
	...
	cost = 2
	var_changes = list("unarmed_attacks" = list(/decl/natural_attack/stomp, /decl/natural_attack/kick, /decl/natural_attack/claws, /decl/natural_attack/bite/sharp))

	apply(var/datum/species/S,var/mob/living/carbon/human/H)
		..(S,H)
		for(var/u_type in S.unarmed_attacks)
...
/datum/trait/venom
	...
	cost = 4
	var_changes = list("unarmed_attacks" = list(/decl/natural_attack/stomp, /decl/natural_attack/kick, /decl/natural_attack/punch/venom, /decl/natural_attack/bite/venom))
