...
/datum/category_item/player_setup_item/skyrat/traits
	name = "Traits"
	sort_order = 2

/datum/category_item/player_setup_item/skyrat/traits/load_character(var/savefile/S)
...
/datum/category_item/player_setup_item/skyrat/traits/save_character(var/savefile/S)
...
/datum/category_item/player_setup_item/skyrat/traits/sanitize_character()
...
datum/preferences/copy_to(mob/living/carbon/human/character, is_preview_copy = FALSE)
	...
	for(var/obj/item/organ/external/E in character.organs)	//Forces the base species stuff onto the limbs
		...
		if(!BP_IS_PROSTHETIC(E))	//Check if the limb is robotic
...
/datum/category_item/player_setup_item/skyrat/traits/content(var/mob/user)
	. += "<b>Custom Species</b> "
...
/datum/category_item/player_setup_item/skyrat/traits/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(!CanUseTopic(user))
