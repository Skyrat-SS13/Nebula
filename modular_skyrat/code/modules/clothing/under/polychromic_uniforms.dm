...
/obj/item/clothing/under/polychromic	//enables all three overlays to reduce copypasta and defines basic stuff
	...
	icon = 'modular_skyrat/icons/obj/clothing/polychromic_uniforms.dmi'
	icon_override = 'modular_skyrat/icons/mob/onmob/polychromic_uniforms.dmi'
	icon_state = "polysuit"
	item_color = "polysuit"
	item_state = "sl_suit"
	hasprimary = TRUE
...
/obj/item/clothing/under/polychromic/get_mob_overlay(mob/user_mob, slot)	//this is where the main magic happens. Also mandates that ALL polychromic stuff MUST USE icon_override
	var/image/ret = ..()
	if(hasprimary | hassecondary | hastertiary)
		var/list/ret_overlays = list()
		if(slot == slot_w_uniform_str)	//prevents the worn sprites from showing up if you're just holding them
