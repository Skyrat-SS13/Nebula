...
/datum/computer_file/report/recipient/corp/payout/generate_fields()
	...
	add_field(/datum/report_field/pencode_text, "As well as the net-worth of any remaining personal assets: (Asset, [cur.name_singular] Amount)")
