...
/obj/item/clothing/under/terran
	...
	icon = 'modular_skyrat/maps/torch/icons/obj/obj_under_terran.dmi'
	item_icons = list(slot_w_uniform_str = 'modular_skyrat/maps/torch/icons/mob/onmob_under_terran.dmi')
