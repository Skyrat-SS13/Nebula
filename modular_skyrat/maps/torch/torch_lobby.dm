/datum/map/torch
	lobby_screens = list('modular_skyrat/maps/torch/lobby/ship.gif','modular_skyrat/maps/torch/lobby/hullside.gif','modular_skyrat/maps/torch/lobby/torchlogo.gif')
	lobby_tracks = list(
