...
/turf/simulated/floor/plating/vox
	initial_gas = list(/decl/material/gas/nitrogen = MOLES_N2STANDARD*1.25)
...
/obj/machinery/alarm/vox/Initialize()
	.=..()
	TLV[/decl/material/gas/oxygen] =	list(-1, -1, 0.1, 0.1) // Partial pressure, kpa
	TLV[/decl/material/gas/nitrogen] = list(16, 19, 135, 140) // Partial pressure, kpa
