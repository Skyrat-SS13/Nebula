...
/mob/living/simple_animal/hostile/meatstation
	...
	desc = "it's meaty!"
	icon = 'modular_skyrat/maps/away/meatstation/meatstation_sprites.dmi'
	response_help = "pats"
...
/mob/living/simple_animal/hostile/meatstation/meatworm
	...
	maxHealth = 20
	health = 20
	natural_weapon = /obj/item/natural_weapon/gnaw
...
/obj/item/natural_weapon/gnaw
	attack_verb = list("gnawed")
	force = 7
